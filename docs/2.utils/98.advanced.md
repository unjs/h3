...
### `replaceSession(event, config, replace)`
...
This function merges the updated properties with the current data. If you would like to override the session data, use `replaceSession`.
