...
> [!NOTE]
> If you use [`unjs/listhen`](https://github.com/unjs/listhen?tab=readme-ov-file#readme), you've just to create a `public` directory in your project root and put your static assets in it. They will be served automatically.
...
> [!NOTE]
> If you're are using [`unjs/listhen`](https://github.com/unjs/listhen?tab=readme-ov-file#readme) and want to try this example, create a directory with another name than `public` because it's the default directory used by `listhen`.
