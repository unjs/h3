...
Then we create a [router instance](/guide/router) that can match route patterns and http methods using [unjs/rou3](https://github.com/unjs/rou3) and register it for app as main handler:
