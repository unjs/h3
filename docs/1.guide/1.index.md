...
Finally, we use [unjs/listhen](https://github.com/unjs/listhen?tab=readme-ov-file#readme) CLI using npx to auto install it. Listhen will automatically setup and start our webserver with zero configuration and adds on-the-fly TypeScript support to your experience!
