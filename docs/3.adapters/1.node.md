...
Alternatively, you can use [unjs/listhen](https://https://github.com/unjs/listhen?tab=readme-ov-file#readme). In this method, you only need to make `app.mjs` with a `default` or `app` export.
